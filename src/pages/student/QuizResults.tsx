    ...
    questions: [
      {
        ...
        correctAnswer: 1,
        explanation:
          "إدارة المخازن تشمل تنظيم وتخزين ومتابعة البضائع بشكل فعال.",
        points: 5,
      },
      {
        id: "2",
      ...
      <LEMSLayout userRole="student">
        <div className="max-w-4xl mx-auto text-center py-12">
          ...
          <p className="text-muted-foreground mb-4">
            لم يتم العثور على نتائج لهذا الاختبار
          </p>
          <Button asChild>
        ...
        <Card className="lems-card">
          <div className="space-y-6">
            <div className="text-center space-y-4">
              ...
              >
                {isPassed
                  ? `تجاوزت الحد الأدنى ${quiz.minimumScore}%`
                  : `تحتاج ${quiz.minimumScore}% للنجاح`}
              </Badge>
            </div>
          </div>
        </Card>
                    ...
                    <div className="text-left">
                      <div
                        className={`text-2xl font-bold ${
                          attempt.score >= quiz.minimumScore
                            ? "text-success"
                            : "text-destructive"
                        }`}
                      >
